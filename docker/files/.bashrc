...
# -----------------------------------------------------------------------------#
# CUSTOMIZATION BY Romano Romano <romano.romano@gmail.com>
# -----------------------------------------------------------------------------#

# Set PATH to include user local binaries
export PATH=$HOME/.tfenv/bin:$HOME/.local/bin:$PATH

# Display Git branch and Terraform workspace in the command line prompt
...
export PS1='\[\e[32m\][\u@\h:\[\e[93m\]\w \[\e[96m\]$(__git_ps1 "(%s)")\[\e[95m\]$(terraform_prompt)\[\e[32m\]]\$\[\e[00m\] '
